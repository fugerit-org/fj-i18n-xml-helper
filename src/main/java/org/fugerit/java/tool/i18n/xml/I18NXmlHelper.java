...
public class I18NXmlHelper {
    ...
    /**
     * [OPTIONAL] The path to an xslt, if not set a default xlst will be used, if set to 'legacy' can lead lead to different
     * behaviors depending on JDK used,
    ...
    public static int handle(Properties params) {
        return ObjectUtils.objectWithDefault(SafeFunction.get(() -> {
            ...
            if (help != null) {
                ...
                ArgHelper.checkAllRequiredThrowRuntimeEx(params, ARG_INPUT_XML, ARG_INPUT_XML, ARG_OUTPUT_PROPERTIES,
                        ARG_CONVERT_CONFIG);
