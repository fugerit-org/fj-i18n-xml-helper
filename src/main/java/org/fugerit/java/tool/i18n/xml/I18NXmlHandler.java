...
public class I18NXmlHandler {
    ...
    private void handleCurrentRule(RuleContext ruleContext, FactoryType ruleConfig, Element root)
            throws XMLException, ClassNotFoundException, NoSuchMethodException, ConfigException {
    ...
    private void handleXmlFile(I18NXmlContext context, File inputXml, File outputXml, RuleContext ruleContext,
            Collection<FactoryType> rules)
            throws IOException, XMLException, ClassNotFoundException, NoSuchMethodException, ConfigException {
        ...
        if (inputXml.isDirectory()) {
            ...
            try (FileInputStream fis = new FileInputStream(inputXml);
                ...
                // write output xml
                String outputXslt = context.getParams().getProperty(I18NXmlHelper.ARG_OUTPUT_XSLT,
                        "cl://tool-i18n-xslt/default-print-xml.xslt");
